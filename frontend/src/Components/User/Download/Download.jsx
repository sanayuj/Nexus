          ...
          <div className="container">
            <div className="row">
              ...
              >
                <div align="center">
                  <img
                    src={`http://localhost:4000/img/${selectedData?.appIcon}`}
                    alt="Sample app icon"
                    className="appLogo"
                    id="img1"
                  />
                ...
                <br />
                <h3 id="head1" align="center">
                  {selectedData?.appName}
                </h3>
                <br />
                <h6 id="head2" align="center">
                  {selectedData?.publisherName}
                </h6>
                <br />
                ...
                <div align="center">
                  <button id="btn3" align="center"onClick={()=>navigate(`/report/${selectedData?._id}`)} >
                    <i class="bi bi-flag" id="flag"></i>Report app
                  </button>
                </div>
              </div>
              <div
              ...
              >
                <div align="center" id="subdiv2">
                  <h4 id="divh">Screen Shots</h4>
                  <br />
                  <hr id="imghr" />
                  <br />
                  <img
                    src={`http://localhost:4000/img/${selectedData?.appScreenshot}`}
                    alt="Sample screen shots"
                    id="img2"
                    className="Screenimage"
                  />
                </div>
                <div align="center" id="subdiv3">
                  <h4 id="divh">Description</h4>
                  <br />
                  <hr id="deschr" />
                  <br />
